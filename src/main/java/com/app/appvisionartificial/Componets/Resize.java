    ...
    public Resize(Stage stage, double w) {
        ...
        root.setOnMouseMoved(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                } else if (((X > sW - w) && (Y < w)) || ((X > sW - 2 * w) && (Y < w)) || ((X > sW - w) && (Y < 2 * w))) {
                ...
                } else if (((X > sW - w) && (Y > sH - w)) || ((X > sW - 2 * w) && (Y > sH - w)) || ((X > sW - w) && (Y > sH - 2 * w))) {
                ...
                } else if (((X < w) && (Y > sH - w)) || ((X < 2 * w) && (Y > sH - w)) || ((X < w) && (Y > sH - 2 * w))) {
